$(document).ready(function() {
		...
		$("<button>").attr("id", "pl-sk-hi").html("Play Energy").appendTo("#elektronomia-sky-high-js-player-div");
    ...
    $("<button>").text("Loop Energy").attr("id", "lp-sk-hi").appendTo("#elektronomia-sky-high-js-player-div");
